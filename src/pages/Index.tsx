...
const courses = [
  {
    id: 1,
    tag: "Хатха-йога",
    title: "Тело как инструмент осознанности",
    desc: "Глубокая практика асан, пранаяма и медитация для начинающих и практикующих.",
    duration: "8 недель",
    lessons: 24,
  },
  {
    id: 2,
    tag: "Философия",
    title: "Веданта: познание себя",
    desc: "Изучение классических текстов — Упанишады, Бхагавад-гита, Йога-сутры Патанджали.",
    duration: "12 недель",
    lessons: 36,
  },
  {
    id: 3,
    tag: "Йога-нидра",
    title: "Практика глубокого расслабления",
    desc: "Техники осознанного сна, визуализации и работы с подсознанием.",
    duration: "4 недели",
    lessons: 12,
  },
];
      ...
      <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
        ...
        <div className="order-1 md:order-2">
          ...
          <div className="space-y-5 mb-10">
            {[
              "Сертифицированный преподаватель йоги по стандарту Yoga Alliance (500 часов), обучалась в Индии в традиции Кришнамачарьи.",
          ...
          <div className="flex flex-wrap gap-3 mb-10">
            {["Хатха-йога", "Веданта", "Пранаяма", "Санскрит", "Медитация"].map((skill) => (
              <span
                key={skill}
