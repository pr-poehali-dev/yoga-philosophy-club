...
const courses = [
  ...
  },
  {
    id: 4,
    tag: "Пранаяма",
    title: "Азы трансформационного дыхания",
    desc: "Дыхание — это корень. Без него дерево вашей практики, будь то хатха-йога или пранаяма, просто не принесёт плодов. Тот, кто поливает только ветви (внешние формы), никогда не доберётся до сути.",
    details: "Это не просто «упражнения». Это инструмент управления вашим состоянием на биологическом уровне. Регулярная практика дыхания из этого курса — это:\n\nФундамент здоровья: насыщение клеток кислородом и работа с нервной системой.\nЭнергетический баланс: выход из хронического стресса и апатии.\nЧистота ума: когда дыхание спокойно, отношения с собой и миром выстраиваются сами собой.\n\nЯ сам был скептиком, пока пранаяма не стала моей реальностью и не изменила мою жизнь до неузнаваемости. Теперь я передаю этот опыт вам. Сделайте первый шаг к фундаменту вашей силы. Пройдите базу, чтобы двигаться дальше в глубины Сакральной Зоны.",
    duration: "По запросу",
    lessons: 1,
  },
  {
    id: 5,
    tag: "Практики",
    title: "Регулярные практики: Синергия Йоги, Цигун и Нейрофизиологии",
    desc: "Это база вашего ежедневного преображения. Мы создали систему полноценных занятий, где древние знания о теле встречаются с современной наукой.",
    details: "Что делает наши практики уникальными?\n\nГлубокая трансформация: каждое занятие выстроено по особым последовательностям на основе анатомии нервной системы. Мы не просто тянем мышцы — мы перенастраиваем ваш «биологический компьютер».\n\nРабота со стихиями и чакрами: мы очищаем энергетические центры и выравниваем баланс первоэлементов внутри физического тела, наполняя каждую клетку силой.\n\nИнструменты Цигун: элементы Цигун вплетены в практику как мощный рычаг для очищения каналов и мгновенного наполнения энергией.\n\nВыбирайте свой ритм:\n1. Full-формат (от 50 минут) — для тотального погружения, глубокой проработки и полной перезагрузки всех систем.\n2. Short-формат (20 минут) — интенсивная практика для поддержания ресурса, когда время ограничено, но чистота ума и тела необходимы.\n\nНачните практиковать осознанно в Сакральной Зоне.",
    duration: "По запросу",
    lessons: 1,
  },
  {
    id: 6,
    tag: "Веданта",
    title: "Сатсанги: Глубина Традиции и Практическая Мудрость",
    desc: "В «Сакральной Зоне» мы изучаем Веды не как теорию, а как руководство к действию. Сатсанги с Тельманом и приглашёнными гостями — это соприкосновение с авторитетным знанием, передающимся по цепи ученической преемственности (парампаре).",
    details: "Почему это важно? Только через преемственность знание сохраняет свою чистоту и силу. Мы не тратим время на обсуждение абстрактных вещей, которые никак не меняют вашу жизнь.\n\nМетафора спасения: если вас укусила змея, нет смысла изучать химический состав яда или траекторию её движения. Вам нужно противоядие — прямо сейчас.\n\nНаши сатсанги носят именно такой характер. Мы не философствуем впустую, а даём практичные ответы на фундаментальные вопросы: как обрести истинное счастье, как действовать в сложные времена и как реализовать свою духовную природу в современных реалиях.\n\nПолучите доступ к знаниям, которые меняют жизнь, а не просто наполняют голову информацией.",
    duration: "По запросу",
    lessons: 1,
  },
];
      ...
      <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
        ...
        <div className="order-1 md:order-2">
          ...
          <div className="space-y-5 mb-10">
            {[
              "В йоге с 2014 года. Получил традиционное йогическое образование и прослужил 2 года в ведическом монастыре. Это даёт моим практикам глубокую, аутентичную основу.",
          ...
          <div className="flex flex-wrap gap-4">
            <a
              ...
              onMouseLeave={(e) => (e.currentTarget.style.background = "var(--gold)")}
            >
              Задать вопрос Тельману по Мистической Йоге
            </a>
            <a
              href="https://web.tribute.tg/s/ToA"
              target="_blank"
            ...
            >
              <span>Подписаться в Мистическую Йогу — <span style={{ textDecoration: "line-through", opacity: 0.5 }}>2500₽</span> 777₽/мес</span>
              <span className="font-golos text-[10px] font-light mt-0.5" style={{ color: "#7a6850" }}>(если ссылка не открывается с PC — откройте с телефона)</span>
            </a>
          </div>
        </div>
      </div>
